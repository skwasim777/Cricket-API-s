...
public class Match {
	...
	@Enumerated
	private MathStatus status;
	private Date date = new Date();

	public void setMatchStatus() {
		if (textComplete.isBlank()) {
			this.status = MathStatus.LIVE;
		} else {
			this.status = MathStatus.COMPLETED;
		}
	}
	...
	public Match(Integer matchId, String teamHeading, String matchNumberVenue, String battingTeam,
			String battingTeamScore, String bowlTeam, String bowlTeamScore, String liveText, String matchLink,
			String textComplete, MathStatus status, Date date) {
		super();
	...
	public MathStatus getStatus() {
		return status;
	}

	public void setStatus(MathStatus status) {
		this.status = status;
	}
